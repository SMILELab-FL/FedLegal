...
class FedOptClientTrainer(BaseClientTrainer, ABC):
    ...
    def fed_train(self, model_parameters: torch.Tensor, id_list: List):
        ...
        for idx in id_list:
            ...
            param_delta_list.append(model_parameters - self.model_parameters)

        return param_delta_list


class FedOptClientTrainerCRF(CRFClientTrainer, ABC):
    def __init__(self, model, train_dataset, valid_dataset, test_dataset):
        super().__init__(model, train_dataset, valid_dataset, test_dataset)
...
class FedOptClientManager(BaseClientManager, ABC):
