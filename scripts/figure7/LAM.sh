...
config_file="config_files/${task,,}/layers_f1_micro/cen_lr_5e-5_ep_20_layers_3.yaml"
bash cen_run.sh ${RUN_DIR} ${task} centralized ${config_file} 18000 0

echo "Layer 6 for centralized"
config_file="config_files/${task,,}/layers_f1_micro/cen_lr_5e-5_ep_20_layers_6.yaml"
bash cen_run.sh ${RUN_DIR} ${task} centralized ${config_file} 18000 0


echo "Layer 3 for standalone"
config_file="config_files/${task,,}/layers_f1_micro/local_lr_5e-5_ep_20_layers_3.yaml"
bash cen_run.sh ${RUN_DIR} ${task} local ${config_file} 18000 0

echo "Layer 6 for standalone"
config_file="config_files/${task,,}/layers_f1_micro/local_lr_5e-5_ep_20_layers_6.yaml"
bash cen_run.sh ${RUN_DIR} ${task} local ${config_file} 18000 0
