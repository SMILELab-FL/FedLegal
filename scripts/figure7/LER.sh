...
config_file="config_files/${task,,}/layers/cen_lr_5e-5_layers_3.yaml"
bash cen_run.sh ${RUN_DIR} ${task} centralized ${config_file} 18000 0

echo "Layer 6 for centralized"
config_file="config_files/${task,,}/layers/cen_lr_5e-5_layers_6.yaml"
bash cen_run.sh ${RUN_DIR} ${task} centralized ${config_file} 18000 0


echo "Layer 3 for standalone"
config_file="config_files/${task,,}/layers/local_lr_5e-5_layers_3.yaml"
bash cen_run.sh ${RUN_DIR} ${task} local ${config_file} 18000 0

echo "Layer 6 for standalone"
config_file="config_files/${task,,}/layers/local_lr_5e-5_layers_6.yaml"
bash cen_run.sh ${RUN_DIR} ${task} local ${config_file} 18000 0


echo "Layer 3 for fedavg"
config_file="config_files/${task,,}/layers/fed_silo_lr_5e-5_layers_6.yaml"
